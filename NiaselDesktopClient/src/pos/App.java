...
public class App {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                if (instance.getAuthController().getCurrentUser().isEmpty()) {
...
//                loginPage.setExtendedState(Frame.MAXIMIZED_BOTH);
                ...
                JOptionPane.showMessageDialog(null, new JLabel(ex.getMessage()), "App Error", JOptionPane.ERROR_MESSAGE);
            }
        });
    }
